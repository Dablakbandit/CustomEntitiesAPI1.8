...
public class MapMaker extends Tracer {
    ...
    public static void main1(String className) throws Exception {
        ...
        //ja.CtClass cc = cp.get(className);
        ja.CtClass cc = cp.makeClass(new java.io.FileInputStream(className));
    ...
    public static void main2(String[] args) throws Exception {
        ClassPool cp = ClassPool.getDefault();
        //ja.CtClass cc = cp.get(args[1]);
        ja.CtClass cc = cp.makeClass(new java.io.FileInputStream(args[1]));
        MethodInfo minfo;
