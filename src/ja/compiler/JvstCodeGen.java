...
import ja.*;
import ja.bytecode.*;
import ja.compiler.ast.*;

/* Code generator accepting extended Java syntax for ja.
 */
...
public class JvstCodeGen extends MemberCodeGen {
    ...
    public void atMember(Member mem) throws CompileError {
        ...
        if (name.equals(paramArrayName)) {
            ...
            bytecode.addInvokestatic("ja/runtime/Desc", "getParams",
    ...
    private void callGetType(String method) {
        bytecode.addInvokestatic("ja/runtime/Desc", method,
                                "(Ljava/lang/String;)Ljava/lang/Class;");
        exprType = CLASS;
        arrayDim = 0;
        className = "java/lang/Class";
    ...
    protected void atCflow(ASTList cname) throws CompileError {
        ...
        bytecode.addGetstatic((String)names[0], (String)names[1],
                              "Lja/runtime/Cflow;");
        bytecode.addInvokevirtual("ja.runtime.Cflow",
                                  "value", "()I");
        exprType = INT;
        arrayDim = 0;
        className = null;
