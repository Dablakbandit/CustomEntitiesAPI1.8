...
public class URLClassPath implements ClassPath {
     ...
     * If <code>packageName</code> is "org.ja." and a requested class is
     * "org.ja.test.Main", then the given URL is used for loading that class.
     * The <code>URLClassPath</code> obtains a class file from:
     *
     * <ul><pre>http://www.ja.org:80/java/classes/org/ja/test/Main.class
     * </pre></ul>
     *
     * <p>Here, we assume that <code>host</code> is "www.ja.org",
