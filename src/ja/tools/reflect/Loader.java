 ...
 *     ja.tools.reflect.Loader cl
 *         = (ja.tools.reflect.Loader)Main.class.getClassLoader();
 ...
 *
 * <ul><pre>% java ja.tools.reflect.Loader Main arg1, ...</pre></ul>
 *
 ...
 * public class Main2 {
 *   public static void main(String[] args) throws Throwable {
 *     ja.tools.reflect.Loader cl = new ja.tools.reflect.Loader();
 *     cl.makeReflective("Person", "MyMetaobject",
 *                       "ja.tools.reflect.ClassMetaobject");
 *     cl.run("MyApp", args);
 *   }
 ...
 * is loaded by <code>ja.tools.reflect.Loader</code> whereas the class
 ...
 * to the same name space as <code>ja.tools.reflect.Loader</code>.
 * For more details,
 * see the notes in the manual page of <code>ja.Loader</code>.
 *
 ...
 *     ja.Loader cl
 *         = new ja.Loader(ClassPool.getDefault(reflection));
 ...
 * <p><b>Note:</b>
 *
 * <p><code>ja.tools.reflect.Loader</code> does not make a class reflective
 ...
 * modified with <code>ja.tools.reflect.Compiler</code> and the original
 * class files should be replaced.
 *
 * @see ja.tools.reflect.Reflection
 * @see ja.tools.reflect.Compiler
 * @see ja.Loader
 */
public class Loader extends ja.Loader {
    ...
    public Loader() throws CannotCompileException, NotFoundException {
        super();
        delegateLoadingOf("ja.tools.reflect.Loader");
