 ...
 * without <code>ja.tools.reflect.Loader</code>
...
public class Compiler {
        ...
        throws Exception
    {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (entries[i].metaobject != null
                ...
                if (entries[i].metaobject == null)
                    metaobj = "ja.tools.reflect.Metaobject";
                else
                    metaobj = entries[i].metaobject;

                if (entries[i].classobject == null)
                    classobj = "ja.tools.reflect.ClassMetaobject";
                else
    ...
    private static void help(PrintStream out) {
        out.println("Usage: java ja.tools.reflect.Compiler");
