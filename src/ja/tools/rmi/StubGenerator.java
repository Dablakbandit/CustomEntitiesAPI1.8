...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "ja.tools.rmi.Sample";
     ...
     * This is a method declared in ja.Translator.
     *
     * @see ja.Translator#start(ClassPool)
     */
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "ja.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "ja.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("ja.tools.rmi.RemoteException") };
    }

    /**
     * Does nothing.
     * This is a method declared in ja.Translator.
     * @see ja.Translator#onLoad(ClassPool,String)
     */
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("ja.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
