 ...
 *
 * <p><b>Note:</b> although this class is included in the ja API,
 * it is provided as a sample implementation of the web server using
 * ja.  Especially, there might be security flaws in this server.
...
public class Webserver {
     ...
     * ja automatically translates "/" into a platform-dependent
     * character.)
    ...
    public static void main(String[] args) throws IOException {
        if (args.length == 1) {
            ...
            System.err.println(
                        "Usage: java ja.tools.web.Webserver <port number>");
    }
