...
/*
 * This class is implemented only with the lower-level API of ja.
 ...
 * with previous releases of ja. Unfortunately,this legacy behaviour makes caching
 * and reuse of proxy classes impossible. The current programming model expects ja
 ...
 * {@link ja.util.proxy.ProxyObjectOutputStream} and {@link ja.util.proxy.ProxyObjectInputStream}
 * (which are subclasses of {@link java.io.ObjectOutputStream} and  {@link java.io.ObjectInputStream})
 * to serialize and deserialize, respectively, the proxy. These streams recognise ja proxies and ensure
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "ja.util.proxy.RuntimeSupport";
     ...
     * setting retains the old ja behaviour which has the advantage that it
    ...
    /**
     * determine if a class is a ja proxy class
     * @param cl
     * @return true if the class is a ja proxy class otherwise false
     */
    ...
    protected ClassLoader getClassLoader0() {
        ...
        if (loader == null) {
            ...
            // In case ja is in the endorsed dir
            if (loader == null) {
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("ja.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
                             "(Ljava/lang/Object;)Lja/util/proxy/SerializedProxy;");
        code.addOpcode(Opcode.ARETURN);
        minfo.setCodeAttribute(code.toCodeAttribute());
        return minfo;
    }
