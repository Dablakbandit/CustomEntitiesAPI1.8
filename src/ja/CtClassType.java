...
import ja.bytecode.AccessFlag;
import ja.bytecode.AttributeInfo;
...
import ja.bytecode.ConstantAttribute;
import ja.bytecode.CodeIterator;
import ja.bytecode.ConstPool;
import ja.bytecode.Descriptor;
import ja.bytecode.EnclosingMethodAttribute;
import ja.bytecode.FieldInfo;
import ja.bytecode.InnerClassesAttribute;
import ja.bytecode.MethodInfo;
import ja.bytecode.ParameterAnnotationsAttribute;
import ja.bytecode.SignatureAttribute;
import ja.bytecode.annotation.Annotation;
...
class CtClassType extends CtClass {
   ...
   /**
    ...
    /**
     * @see ja.CtClass#prune()
     * @see ja.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
