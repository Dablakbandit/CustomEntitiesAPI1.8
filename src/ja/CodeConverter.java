 ...
 * (also see the <code>ja.expr</code> package).
 *
 ...
 *
 * @see ja.CtClass#instrument(CodeConverter)
 * @see ja.CtMethod#instrument(CodeConverter)
 * @see ja.expr.ExprEditor
 */
public class CodeConverter {
     ...
     * @see ja.CtMethod#setName(String)
     */
