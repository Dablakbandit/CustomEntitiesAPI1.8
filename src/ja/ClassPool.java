...
public class ClassPool {
    ...
    /**
     * Record a package name so that the ja compiler searches
     ...
     * <code>ja.bytecode.ClassPool</code>.  <code>getClassInfo</code>
     ...
     * @see #get(String)
     * @see ja.bytecode.ConstPool#getClassInfo(int)
     * @see ja.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * class, ja generates constructors and adds it when
