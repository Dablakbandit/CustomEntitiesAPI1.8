 ...
 * interested in the implementation of ja.
 *
...
public abstract class CtClass {
     ...
     * files modified by ja are saved under the directory
     ...
     */
    public ja.compiler.AccessorMaker getAccessorMaker() {
        return null;
    }
     ...
     * @see ja.bytecode.SignatureAttribute#toClassSignature(String)
     ...
     * @see ja.bytecode.SignatureAttribute.ClassSignature#encode()
     * @see ja.bytecode.SignatureAttribute.MethodSignature#encode()
     ...
     * For decoding, use <code>ja.Modifier</code>.
     *
     ...
     * or <code>ja.bytecode.Descriptor</code>.
     *
     * @param desc      method descriptor
     * @see ja.bytecode.Descriptor
     */
     ...
     *
     * @see ja.CtField#CtField(CtField,CtClass)
     */
     ...
     *
     * @see ja.CtField.Initializer#byExpr(String)
     * @see ja.CtField#CtField(CtField,CtClass)
     */
     ...
     * <code>ja.bytecode</code> package.  For example, the following
     ...
     *
     * <p>
     * ja can automatically prune a <code>CtClass</code> object
