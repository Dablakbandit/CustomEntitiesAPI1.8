...
public abstract class CtBehavior extends CtMember {
     ...
     * such as <code>ja.CtBehavior.stBody(String)</code>.
     *
     * @since 3.5
     */
     ...
     * rebuild a stack map table.  ja does not automatically
     * rebuild it for avoiding unnecessary rebuilding.
     *
     * @see ja.bytecode.MethodInfo#rebuildStackMap(ClassPool)
     */
     ...
     * with ja requires a support class
     * <code>ja.runtime.Cflow</code> at runtime
     * (other ja classes are not required at runtime).
     *
    ...
    public void useCflow(String name) throws CannotCompileException {
        ...
        try {
            CtClass type = pool.get("ja.runtime.Cflow");
     ...
     * @see ja.expr.Expr#replace(String)
     * @see #insertBefore(String)
     */
